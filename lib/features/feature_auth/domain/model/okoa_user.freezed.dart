...
class _$OkoaUserImpl implements _OkoaUser {
  ...
  @override
  String toString() {
    return 'OkoaUser(userId: $userId, email: $email, createdAt: $createdAt, userName: $userName, phone: $phone, avatarUrl: $avatarUrl, latitude: $latitude, longitude: $longitude, fcmToken: $fcmToken, messages: $messages, sentRequests: $sentRequests, receivedRequests: $receivedRequests, partners: $partners, sos: $sos)';
  }
